...
<div class="container-fluid mb-3">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Subregion Create</h1>
    @if ($errors->any())
  ...
  <div class="row">
    <div class="offset-md-2 col-md-8">
      <form method="POST" action="{{route('subregions.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
          <label>Name</label>
          <input type="text" name="subregion_name" class="form-control">
        </div>
        <div class="form-group">
